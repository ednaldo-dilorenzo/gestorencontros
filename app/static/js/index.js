...
//   // $.get(match.view, function( data ) {
//   //   $("#app").empty();
//   //   $("#app").append(data);
//   // });
//   // $("#app").empty();
//   $("#app").load(match.view);
//   // $("#app").find("script").each(() => {
...
function showModal(caminhoModal) {
  const modal = document.createElement("div");
  modal.setAttribute("id", "modal-container");
  document.body.append(modal);
  $("#modal-container").load(caminhoModal, function () {
...
$("#lkAlterarSenha").click(() => {
  showModal("/usuarios/senha");
});
