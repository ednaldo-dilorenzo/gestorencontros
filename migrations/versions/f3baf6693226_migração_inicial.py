...
def upgrade():
    ...
    op.execute(
        "INSERT INTO usuario (username, senha, nome, papel) VALUES ('master@test.com', 'pbkdf2:sha256:260000$MHeLL0ROwxQD6VqR$68a8934acb805c942a2c8e10ee5b3abcc94976ca577de5db66d05ca84c685724', 'Master', 'ADMIN')"
    )
    op.create_table(
        "movimento",
        sa.Column("id", sa.Integer(), nullable=False),
